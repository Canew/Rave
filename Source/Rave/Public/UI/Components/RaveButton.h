...
#include "RaveButton.generated.h"

class SButton;
class USlateWidgetStyleAsset;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRaveOnButtonClickedEvent, const URaveButton*, Button);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRaveOnButtonPressedEvent, const URaveButton*, Button);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRaveOnButtonReleasedEvent, const URaveButton*, Button);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FRaveOnButtonHoverEvent, const URaveButton*, Button);
 ...
 */
UCLASS(MinimalAPI)
class URaveButton : public UContentWidget
{
...
public:
	...
	FRaveOnButtonClickedEvent OnClicked;

	/** Called when the button is pressed */
	UPROPERTY(BlueprintAssignable, Category = "Button|Event")
	FRaveOnButtonPressedEvent OnPressed;

	/** Called when the button is released */
	UPROPERTY(BlueprintAssignable, Category = "Button|Event")
	FRaveOnButtonReleasedEvent OnReleased;

	UPROPERTY(BlueprintAssignable, Category = "Button|Event")
	FRaveOnButtonHoverEvent OnHovered;

	UPROPERTY(BlueprintAssignable, Category = "Button|Event")
	FRaveOnButtonHoverEvent OnUnhovered;
